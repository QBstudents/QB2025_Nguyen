...
```{r}
# load data
m = read.table(paste0(getwd(), "/Week1-RStudio/data/matrix.txt"))
...
```{r}
zoop = read.table(paste0(getwd(), "/Week1-RStudio/data/zoop_nuts.txt"), header = TRUE)
df_zoop = as.data.frame(zoop)
summary(df_zoop)
```
